...
\begin{itemize}    
  ...
  \item {\bf 11:00 - 12:00 Contributed Session I-A: Modern Numerical Methods for ODE}  (chairman L. C. McInnes)
  \begin{itemize}
  ...
  \item {\bf 13:30 - 15:30 Contributed Session II-A: Computational dynamics} (chairman J. Kruis) 
  \begin{itemize}
...
\begin{itemize}    
  ...
  \end{itemize}
  \item {\bf 13:30 - 15:30 Contributed Session II-B: Adaptive Methods for Eigenproblems} (chairman J. Principe) 
  \begin{itemize}
  ...
  \end{itemize}
\newpage
    \item {\bf 13:30 - 15:30 Contributed Session II-C: Uncertainty Quantification for PDE} (chairman O. Junge) 
  \begin{itemize}
...
\begin{itemize}    
  \item {\bf 9:00 - 10:00 Contributed Session I-A: Discontinuous Galerkin Methods for Electromagnetics} \\(chairman S. Giani) 
  \begin{itemize}
  ...
  \item {\bf 10:20 - 12:00 Contributed Session II-A: Discontinuous Galerkin Methods for Electromagnetics} (chairman E. Hall) 
  \begin{itemize}
...
Analysis and Simulation
  \end{itemize}
  \item {\bf 10:20 - 12:00 Contributed Session II-B: Fluid Structure Interaction: Methods and Applications} (chairman J. Lang) 
  \begin{itemize}
  ...
  \begin{itemize}
    ...
    \item 14:30 - 14:50 M. Stork: State-Space Energy Based Structure of Generalized Brayton-Moser Nonlinear Network Representations
...
\begin{itemize}    
  ...
  \begin{itemize}
    ...
    \item 9:40 - 10:00 T.-L. Horng: An Error Minimized Pseudospectral Penalty Direct Poisson Solver
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item 9:40 - 10:00 M. Korek: Electronic Structure of the Nanodiatomic Compounds CdS
  \end{itemize}
  \item {\bf 9:00 - 10:00 Contributed Session I-C} (chairman M. \v{S}tork) 
  \begin{itemize}
    ...
    \item 9:20 - 9:40  O. Fernandez: Fractional Dynamics and Anomalous Diffusion, Case Studies Simulations
    \item 9:40 - 10:00 R. Kittipichai: Mass Minimization of Hospital Bed Structure
  \end{itemize}
  \item 10:00 - 10:20 Coffee break
  \item {\bf 10:20 - 11:40 Contributed Session II-A: Multiphysics and Multiscale Problems in Civil Engineering} (chairman P. \v{S}ol\'{i}n) 
  \begin{itemize}
